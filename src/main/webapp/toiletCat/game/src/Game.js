...
this.cshback = new Laya.Sprite();
        ...
        this.csh = new Laya.Text();
        this.csh.color = "#FFFFFF";
		this.csh.font = "Impact";
        this.csh.fontSize = 40;
        this.csh.width = 300;
		this.csh.wordWrap = true;
		...
		socket = new Socket();
		socket.connectByUrl("ws://58.87.84.85:20002");
    ...
    function onLoaded(){
        ...
        this.recharge.zOrder = 300;
        gameRechargeObj = this.recharge;
        this.recharge.visible = false;
        this.recharge.y = 1092;
        Laya.stage.addChild(this.recharge);

	    cshback.visible = false;
        csh.visible = false;
    }
