...
<!-- 该页面功能js -->
<script type="text/javascript" src="/js/back/bannerImg/bannerImg.js"></script>
                ...
                <div class="panel-body" id="row1">
                    <div class="dataTable_wrapper" id="tableDiv">
                        <div id="searchDiv" class="input-group custom-search-form">
                            <button type="button" id="addBanner" onclick="addBannerPage()" class="btn btn-primary">添加记录</button>
