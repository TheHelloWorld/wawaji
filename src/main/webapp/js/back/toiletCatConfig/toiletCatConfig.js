...
// 展示url
var showUrl = "/toiletCat/api/toiletCatConfig/getAllMachineByPage.action";

$(function(){
    // 获得总页数和总数量
    var countAndPageSizeUrl = "/toiletCat/api/toiletCatConfig/getMachineTotalCountAndPageSize.action";
...
function deleteThis(dataParam) {
    ...
    $.ajax({
        url:"/toiletCat/api/toiletCatConfig/deleteMachineByIdAndToyNo.action",
        type:"POST",
        async:false,
        data:{
            id:id,
